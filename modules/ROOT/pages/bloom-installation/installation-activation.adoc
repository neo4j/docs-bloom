...
. *Place the plugin*: First, take a look at the table in link:https://www.neo4j.com/docs/operations-manual/current/configuration/file-locations/#neo4j-plugins[Operations Manual -> File locations] to find where to put the Bloom plugin `.jar` file.
...
You can find the default location for your OS link:https://www.neo4j.com/docs/operations-manual/current/configuration/file-locations/#file-locations-locations[Operations Manual -> File locations].
+
