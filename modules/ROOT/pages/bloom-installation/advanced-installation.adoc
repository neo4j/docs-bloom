...
For more information about the Neo4j Docker image, please see link:https://www.neo4j.com/docs/operations-manual/current/docker/introduction#docker-image[Operations Manual -> Using the Neo4j Docker image].
...
The Neo4j Docker image includes a startup script which automatically downloads and lets you configure the Bloom plugin at runtime, see link:https://www.neo4j.com/docs/operations-manual/current/docker/operations/#docker-neo4jlabs-plugins[Operations Manual -> Configure Neo4j Labs plugins] for more information.
...
For more information about Neo4j clusters, see link:https://www.neo4j.com/docs/operations-manual/current/clustering/[Operations Manual -> Clustering].
