...
As mentioned in xref:../bloom-installation/bloom-deployment-modes.adoc#bloom-in-aura[Bloom in Neo4j Aura], Bloom is available as the _Explore_ tab in Workspace _or_ as a standalone app in the Aura console.
